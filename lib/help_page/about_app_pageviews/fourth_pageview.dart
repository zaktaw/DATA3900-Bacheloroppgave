  ...
  Widget build(BuildContext context) {
    ...
    Column(
        children: [
          ...
          Container(child: Image.asset("assets/images/help_confirm_count.gif"), decoration: BoxDecoration(border: Border.all(color: Colors.black)), height: MediaQuery.of(context).size.height * GIF_PAGEVIEW_MARGIN_FACTOR_HEIGHT, width: MediaQuery.of(context).size.height * GIF_PAGEVIEW_MARGIN_FACTOR_WIDTH),
      ],
      )
    );
  }
