...
class FirstPageview extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SingleChildScrollView( 
      ...
      Container(child: Image.asset("assets/images/help_main_menu.gif"), decoration: BoxDecoration(border: Border.all(color: Colors.black)), height: MediaQuery.of(context).size.height * GIF_PAGEVIEW_MARGIN_FACTOR_HEIGHT, width: MediaQuery.of(context).size.height * GIF_PAGEVIEW_MARGIN_FACTOR_WIDTH),
      ],
    ));
  }
}
